...
var baseUrl = scriptElement !== null ? scriptElement.getAttribute('src').replace(/\/frozen_cookies\.js$/, '') : 'https://rawgit.com/kisslab69/FrozenCookies/master';
...
var script_list = [
    ...
    FrozenCookies.baseUrl + '/IOUtils.js',
    FrozenCookies.baseUrl + '/EVDecomposition.js',
    FrozenCookies.baseUrl + '/LUDecomposition.js',
    FrozenCookies.baseUrl + '/Matrix.js',
